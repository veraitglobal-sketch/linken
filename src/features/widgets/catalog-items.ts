...
export const WIDGET_CATALOG: WidgetDefinition[] = [
  {
    ...
    name: "Footer strip",
    description:
      "Slim footer bar — Hansala Verified plus drifting partner logos.",
    section: "placement",
    placement: "footer",
    recommended: true,
    height: 52,
  ...
  },
  {
    ...
    description:
      "Confirmed partner logos that swap or scroll — for trust sections.",
    section: "placement",
    placement: "partners",
    pro: true,
    height: logoWallHeight("swap-random", "md"),
  ...
  },
  {
    ...
    name: "Case gallery",
    description:
      "Grid of client-confirmed case studies for your Work page.",
    section: "placement",
    placement: "cases",
    pro: true,
    height: 280,
