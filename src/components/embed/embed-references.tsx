import { EmbedLinkenMark } from "@/components/embed/embed-brand";
import {
  embedAccentClass,
  embedInkClass,
  embedMutedClass,
...
export function EmbedReferences({
  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between gap-3 pr-14">
        <p
          className={cn(
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className={cn("truncate text-[11px]", embedMutedClass(theme))}>
                  {ref.service}
                </p>
              </div>
              <span
