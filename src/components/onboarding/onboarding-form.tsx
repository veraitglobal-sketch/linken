...
export function OnboardingForm({ error }: Props) {
  ...
  return (
    <div className="relative flex flex-col justify-center border-t border-line bg-[#fbfbfc] px-6 py-8 sm:px-9 sm:py-10 lg:border-t-0 lg:border-l lg:border-white/10">
      ...
      <div className="animate-rise-delay mt-5 rounded-2xl border border-[#10231f]/10 bg-[#10231f] px-4 py-3 text-white">
        ...
        <p className="mt-1 font-display text-lg tracking-[-0.03em]">
          linken.com/<span className="text-[#5ec4a8]">{slug}</span>
        </p>
      </div>
      ...
      >
        ...
        <label className="block">
          ...
          <textarea
            ...
            className="min-h-[5.5rem] w-full resize-none rounded-xl border border-line bg-white px-3.5 py-3 text-sm leading-relaxed text-ink outline-none transition-colors placeholder:text-muted focus:border-[#1f6b5c] focus:ring-2 focus:ring-[rgba(31,107,92,0.15)]"
          />
        </label>
