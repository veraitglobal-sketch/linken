  ...
  return (
    <div className="relative shrink-0">
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((v) => !v)}
        className="flex h-7 w-7 items-center justify-center rounded-none text-muted transition-colors hover:bg-paper hover:text-ink"
      >
      ...
      {open ? (
        <div className="absolute top-8 right-0 z-20 min-w-[11rem] rounded-none border border-line bg-white p-2 shadow-[0_12px_30px_rgba(10,20,18,0.12)]">
