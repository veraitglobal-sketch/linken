...
export function DocsHero({ siteUrl, basePath, previewTokens }: Props) {
  ...
  return (
    <section className="px-0 pt-0">
      <div className="relative grid overflow-hidden rounded-[32px] bg-[#10231f] lg:min-h-[420px] lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 break-all font-display text-lg tracking-[-0.03em] text-white sm:text-xl">
                    ...
                    <span className="text-[#5ec4a8]">{basePath}</span>
                  </p>
                </div>
        ...
        <div className="relative border-t border-white/10 lg:border-t-0 lg:border-l lg:border-white/10">
          <div className="flex h-full flex-col bg-[#0a1714]/70 px-4 py-5 sm:px-6 sm:py-7">
            <div className="mb-3 flex items-center justify-between gap-2">
              <p className="text-[10px] font-semibold tracking-[0.14em] text-white/40 uppercase">
                GET · companies/{"{slug}"}
              </p>
              <span className="rounded-full border border-[#5ec4a8]/35 bg-[#5ec4a8]/10 px-2 py-0.5 text-[10px] font-semibold tracking-[0.08em] text-[#5ec4a8] uppercase">
                200
              </span>
            </div>
            <div className="min-h-0 flex-1 overflow-hidden rounded-2xl border border-white/10 bg-[#0a1714]">
              <CodeBlock
